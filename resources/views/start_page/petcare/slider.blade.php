	...
	<div id="main-slider" class="carousel slide carousel-fade col-offset-2" data-ride="carousel">
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="/petcare/images/slider-image/slider-1.jpg" alt="slider-1"/>
			...
			<div class="item">
				<img src="/petcare/images/slider-image/slider-2.jpg" alt="slider-2"/>
				<div class="slider-content">
					<div class="container">
			...
			<div class="item">
				<img src="/petcare/images/slider-image/slider-3.jpg" alt="slider-3"/>
				<div class="slider-content">
					<div class="container">
