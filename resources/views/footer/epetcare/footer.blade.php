		...
		<div class="row border-bottom-black">
			<div class="col-sm-6 col-md-3">
				<div class="widget dark">
					<img class="mb-20" alt="" src="/epetcare/images/logo-wide-white.png">
					<p>Lorem ipsum dolor sit amet, consecte tur adipisi cing elit lestias eius illum libero dolor
					   nobis deleniti.</p>
...
<script
	src="https://maps.googleapis.com/maps/api/js?key={{env('GOOGLE_MAPS_KEY')}}&libraries=places&callback=initAutocomplete&callback=initialize"
	async defer></script>
<script src="/js/ru.js"></script>
<script src="/epetcare/js/messages.js"></script>